#!/usr/bin/env tsx
// =============================================================
// Discover: FieldKeys dos 9 campos "CHECKLIST - CLIENTE" no Ploomes
// Fase 2 do Checklist do Cliente — SOMENTE LEITURA
// =============================================================
// Uso: npx tsx scripts/discover-checklist-cliente-fieldkeys.ts
//
// Pré-requisitos:
...
// ── 9 rótulos alvo — EXATAMENTE como aparecem no enunciado ──────────────────
const TARGETS: Array<{ rotulo: string; termos: string[] }> = [
  { rotulo: 'Quantidade Rolha',                   termos: ['rolha', 'quantidade'] },
  { rotulo: 'Valor do Convidado Extra e Staff',    termos: ['convidado extra', 'staff', 'valor do convidado'] },
  { rotulo: 'Responsável',                         termos: ['responsável'] },
  { rotulo: 'Contratou foto e/ou vídeo?',          termos: ['contratou foto', 'foto e/ou', 'foto.*video', 'contratou.*foto'] },
  { rotulo: 'Gerador',                             termos: ['gerador'] },
  { rotulo: 'Valet custos',                        termos: ['valet'] },
  { rotulo: 'Outros detalhes Checklist Cliente',   termos: ['outros detalhes', 'checklist cliente'] },
  { rotulo: 'Pagou Rolha?',                        termos: ['pagou rolha', 'pagou.*rolha'] },
  { rotulo: 'Detalhamento de Hora Extra',          termos: ['hora extra', 'detalhamento.*hora'] },
]
...
async function main() {
  ...
  console.log('DISCOVER — 9 campos CHECKLIST CLIENTE (Fase 2)')
  console.log('═'.repeat(72))
  console.log()
  ...
  console.log('═'.repeat(72))
  console.log('TABELA FINAL — 9 CAMPOS CHECKLIST CLIENTE')
  console.log('═'.repeat(72))
  console.log()
  console.log('Rótulo                                | FieldKey                                    | ValueKey        | Parser | Exemplo')
  console.log('─'.repeat(120))
  for (const s of summaries) {
    const r = s.rotulo.padEnd(37)
