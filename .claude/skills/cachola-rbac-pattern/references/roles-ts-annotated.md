...
| `PROVIDER_NOTIFY_ROLES` | super_admin, diretor, gerente | Notificações de prestadores em `lib/notifications.ts` e cron `check-provider-alerts` (separada de MAINTENANCE_ADMIN_ROLES por design) |
